...
public class GroupOfCards 
{
   public GroupOfCards(){}
    ...
    public CrazyEights [] cards = new CrazyEights[52];
   ...
   for(CrazyEights.Suits s : CrazyEights.Suits.values()){
    ...
    for(CrazyEights.Value v :CrazyEights.Value.values()){
     ...
     public CrazyEights[] splitArrays( CrazyEights [] cards){
     for(int i =0; i<7; i++ ){
         arr1[i]=cards[i];
     ...
     return arr4;
                  ...
                  public CrazyEights[] available(CrazyEights [] cards){
              int j=28;
     for(int i=0; i<24; i++ ){
     ...
     return availablecards;
                  ...
                  public int randomCard(CrazyEights [] availablecards){
                                            int i = (int)(Math.random()*24);
                                            System.out.println(availablecards[i]);
